...
class EndDataPacket(transactionId: Int, data: ByteArray) :
    AbstractPacket(data.size + 4, PacketType.EndDataPacket) {
    val mData: ByteArray
    ...
    override fun toString(): String {
        ...
        return "EndDataPacket(transactionId=$mTransactionId, data=${sb})"
    }
}